...
const MessagePage = ({ navigation, route }) => {
                ...
                fetch('http://192.168.0.103:3000/userdata', {
                    ...
                    .then(res => res.json()).then(data => {
                        if (data.message == 'User Found') {
                            ...
                            fetch('http://192.168.0.103:3000/otheruserdata', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
    ...
    const sendMessage = async () => {
        ...
        fetch('http://192.168.0.103:3000/savemessagetodb', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const loadMessages = (temproomid) => {
        fetch('http://192.168.0.103:3000/getmessages', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    return (
        <View style={styles.container}>
            <View style={styles.s1}>
                ...
                {
                    fuserdata?.profilepic ? <Image source={{ uri: fuserdata?.profilepic }} style={styles.profilepic} />
                        :
                        <Image ource={nopic} style={styles.profilepic} />
                }
